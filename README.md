...
*In Progress.
Children: People should receive a currency stipend of some kind to allow them to afford children, the amount granted per additional child might decline in the interest of preventing population expansion. Upon reaching maturity the child would receive their adult currency ration.

Retirement: Time currency could be banked indefinitely, and all the other currencies are already granted in their full amount, so only the Time currency would need to be saved and managed for retirement. People might take a few years off work every so often to spend their time; merely existing in a space wouldn't cost much since there isn't debt in the same sense as normal money.

Inheritance: Unspent Time currency is not inherited, except in the case of underaged children who would inherit it so their stand-in caretakers are less burdened. In any other case, if someone dies with unspent Time currency they can elect to have it allocated to a cause they believe in. Unspent Physical currency can be inherited (possibly within limits) because parents should be encouraged to leave resources for their children. Property, which represents spent Physical currency, must be taken in under the budget of the inheritor or released to the public. Doing it this way avoids parents spending unnecessarily in order to pass goods down to their descendents, from an environmental perspective we would rather have the resources remain unused longer than have a flurry of spending activity at the end of life since the Time currency cannot be passed along.*
...
Priority: Those people without a good or service get priority when ordering them. Someone without a house gets to have their need for one met before someone else’s second house is built or bought. There is no out-bidding process. When someone who has not used much of their allotted resources (IE: people in underdeveloped areas) orders something, the relative demand multiplier is higher for servicing their needs. Put simply, you would earn more Time currency providing services to the poor than the rich; the goal is to even out disparities so everyone is living comfortably and sustainably.*
